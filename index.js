               ...
               client.reply(from, `Waalaikumsalam ${pushname}:)`)
                ...
                case 'report':
                     const pesan = body.slice(8)
                      if (pesan.length > 400) return client.sendMessage(from, 'Maaf Teks Terlalu Panjang, Maksimal 300 Teks', msgType.text, {quoted: mek})
               ...
               case 'infogempa':
				...
				case 'bc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							client.sendMessage(_.jid, buff, image, {caption: `*[ HARUKA BROADCAST ]*\n\n${body.slice(4)}`})
						}
				...
				case `addadmin`:
                   ...
                   break
                case 'P':
                   teks = `ya? ketik ${prefix}menu untuk melihat menu bot ini`
